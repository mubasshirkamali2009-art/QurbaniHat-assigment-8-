...
<button className="btn btn-success mx-auto  w-full">Register</button>
 ...
 <p className='text-white  p-5'>already have an account   <Link href="/login" className='text-red-500 text-2xl ' > Login</Link> </p>
  ...
  <div className='flex justify-center'>
    <button onClick={handleGoogleRegister} className='flex justify-center items-center gap-3 sm:gap-5 text-lg sm:text-xl md:text-2xl bg-blue-300 px-4 sm:px-5 py-2 sm:py-3 rounded-2xl w-full sm:w-auto'>
