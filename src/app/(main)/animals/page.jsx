...
const animalsData = [
  ...
  },
  {
    ...
    age: 4,
    location: "Sirajganj",
    description: "বড় ও শক্তিশালী Shahiwal bull. Premium quality, perfect for large Qurbani.",
    category: "Large Animal",
  },
  {
    id: 3,
    ...
    age: 5,
    location: "Dhaka",
    description: "Imported Australian Friesian. Very healthy and well maintained. Ideal for premium Qurbani.",
    category: "Large Animal",
  },
  {
    id: 4,
    name: "Deshi Kalo Chagol",
    type: "Goat",
    breed: "Black Bengal",
    price: 18000,
    weight: 22,
    age: 2,
    location: "Cumilla",
    description: "Pure Black Bengal goat. স্বাস্থ্যকর ও সুন্দর। Great choice for small family Qurbani.",
    category: "Small Animal",
  },
  {
    id: 5,
    name: "Jamuna Pari Bakra",
    type: "Goat",
    breed: "Jamuna Pari",
    price: 35000,
    weight: 45,
    age: 3,
    location: "Rajshahi",
    description: "Large Jamuna Pari goat with excellent build. Well vaccinated and healthy.",
    category: "Small Animal",
  },
  {
    id: 6,
    name: "Arabian Camel",
    type: "Camel",
    breed: "Arabian Dromedary",
    price: 750000,
    weight: 480,
    age: 6,
    location: "Chattogram",
    description: "Rare Arabian camel available for Qurbani. Imported and fully healthy. উট কোরবানির জন্য আদর্শ।",
    category: "Large Animal",
  },
  {
    id: 7,
    ...
    age: 2,
    location: "Mymensingh",
    description: "Healthy Merino sheep, well fed and vaccinated. ভেড়া কোরবানির জন্য উপযুক্ত।",
    category: "Small Animal",
  },
  {
    id: 8,
    ...
    age: 5,
    location: "Pabna",
    description: "Giant Nili Ravi buffalo from Pabna. মহিষ কোরবানির জন্য সেরা পছন্দ। Fully healthy and farm raised.",
    category: "Large Animal",
  },
];
...
const TYPES = ["All", "Cow", "Goat", "Camel", "Sheep", "Buffalo"];
...
const AnimalsPage = () => {
  ...
  const filtered = useMemo(() => {
    let list =
      activeType === "All"
        ? [...animalsData]
        : animalsData.filter((a) => a.type === activeType);
    list.sort((a, b) =>
    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ap-header {
          background: linear-gradient(160deg, #0d2818 0%, #061409 100%);
        ...
        .ap-rule-dot {
          ...
          background: #c8a03a; opacity: 0.7;
        }

        .ap-controls {
          background: #0d2818;
          border-bottom: 1px solid #1e4a2e;
          padding: 16px 20px;
          display: flex;
          flex-wrap: wrap;
          align-items: center;
        ...
        .ap-card:hover {
          ...
          border-color: #c8a03a;
          box-shadow: 0 8px 32px rgba(200, 160, 58, 0.12);
        }
      ...
      <div className="ap-page">
        ...
        <div style={{ background: "#0a1f10" }}>
          <div className="ap-controls">
            <div className="ap-filters">
              ...
              {TYPES.map((t) => (
                <button
                  key={t}
                  className={`ap-filter-btn${activeType === t ? " active" : ""}`}
            ...
            <div className="ap-sort">
              <span className="ap-sort-label">
                <FaSortAmountDown style={{ fontSize: 11 }} />
                Price
              </span>
              <button
                className={`ap-sort-btn${sortOrder === "asc" ? " active" : ""}`}
              ...
              <button
                className={`ap-sort-btn${sortOrder === "desc" ? " active" : ""}`}
          ...
          <p className="ap-count">
            Showing {filtered.length} animal{filtered.length !== 1 ? "s" : ""}
          </p>
                  ...
                  <div className="ap-card-body">
                    ...
                    <div className="ap-card-stats">
                      <div className="ap-stat">
                        <FaWeight className="ap-stat-icon" />
                        {animal.weight} kg
                      </div>
                      <div className="ap-stat">
                        <FaBirthdayCake className="ap-stat-icon" />
                        Age {animal.age}
                      </div>
                      <div className="ap-stat">
                        <FaMapMarkerAlt className="ap-stat-icon" />
                        {animal.location}
                      </div>
                      <div className="ap-stat">
                        <FaTag className="ap-stat-icon" />
                        {animal.type}
                      </div>
                    </div>
